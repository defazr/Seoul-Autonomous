...
const document: LegalDocument = {
  ...
  sections: [
    ...
    },
    {
      title: '10. 광고',
      paragraphs: [
        'Seoul Autonomous는 웹사이트 운영을 위해 Google AdSense를 통한 광고를 표시할 수 있습니다. 광고가 표시되는 경우 다음과 같은 정보 처리가 이루어질 수 있습니다.',
      ],
      bulletPoints: [
        'Google을 포함한 제3자 광고 제공업체가 광고를 제공할 수 있습니다.',
        '광고 제공 과정에서 제3자가 브라우저 또는 기기에 쿠키를 설정하거나 기존 쿠키를 읽을 수 있습니다.',
        '웹 비콘, IP 주소 또는 유사한 기술이 광고 제공과 성과 측정에 사용될 수 있습니다.',
        '이용자의 이전 방문 정보 등을 바탕으로 맞춤 광고 또는 비맞춤 광고가 표시될 수 있습니다.',
      ],
      paragraphsAfter: [
        '이용자는 Google 광고 설정에서 광고 개인 최적화 사용 여부를 관리할 수 있습니다.',
        '유럽경제지역(EEA), 영국, 스위스 등 일부 지역의 이용자에게는 관련 규정과 서비스 설정에 따라 지역별 동의 메시지가 표시될 수 있습니다.',
      ],
    },
    {
      title: '11. 이용자의 선택권',
